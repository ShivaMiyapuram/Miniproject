...
<?php
  ...
  $pdo=dbcon::connect();
  $sql="SELECT * FROM kk_hotels WHERE username='tajkrishna'";
  $row=$pdo->query($sql);
  $details="";
  foreach ($row as $i) {
    $details=$i['details'];
  ...
  <textarea  class="details" name="details" id="" rows="10">
    ...
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae iusto eius voluptatum aliquam tempora libero nesciunt optio laudantium aliquid similique eligendi, esse repellat animi ullam quam. Aliquam veritatis minus, ea.
  </textarea>';
  else{
        echo '
  <textarea  class="details" name="details" id="" rows="10">
